...
class InfographicPolicy
{
     ...
     */
    public function view(User $user, Infographic $infographic): bool
    {
     ...
     */
    public function restore(User $user, Infographic $infographic): bool
    {
     ...
     */
    public function replicate(User $user, Infographic $infographic): bool
    {
